    ...
    <>
      ...
      <div className='mx-auto min-w-screen min-h-screen p-4 text-slate bg-navy'>
        <div className='mx-auto max-w-screen-2xl content-section'>
          <MobileHalo />
          {/* <div className='mobile-halo md:hidden w-max'/> */}
          <NavbarSimple />
                ...
                <div className='col-span-11 md:col-span-6'>
                  <Reveal>
                    <p>
                      ...
                      remarkable digital experiences. My passion lies in learning and contributing
                      to cutting-edge projects that push the boundaries of web development.
                    </p>
                  </Reveal>
                </div>
              ...
              <div className='grid grid-cols-12 gap-y-8 md:gap-x-14 my-10 mx-5'>
                ...
                <div className='col-span-12 md:col-span-7 space-y-4'>
                  <Reveal>
                    <>
                      <p>
                        Hi there! I&apos;m Alok Debnath, a passionate web developer. My journey into
                        coding began during my Computer Engineering. As a naturally curious
                        individual, I&apos;ve always been drawn to creating and breaking things to
                        gain a deeper understanding of their inner workings. This innate curiosity
                        eventually paved the way for my entry into the exciting world of web
                        development.
                      </p>
                      <p>
                        ...
                        learning amidst real-world projects. Exploring and embracing new
                        technologies became an integral part of my daily routine. I relished the
                        opportunity to integrate my knowledge across diverse domains to craft
                ...
                <div className='col-span-12 md:col-span-5'>
                  <p>
                    ...
                    building exceptional digital experiences. I&apos;m eager to learn and contribute
                    to innovative projects in the field.
                  </p>
                </div>
              </div>
            </div>
